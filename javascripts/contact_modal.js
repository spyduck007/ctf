document$.subscribe(function() {
        ...
        <div id="contactModal" class="modal" role="dialog" aria-modal="true" aria-labelledby="contactModalTitle" aria-hidden="true">
          <div class="modal-content" tabindex="-1">
            ...
            <ul class="contact-list">
              ...
              <li>
                <a href="https://github.com/spyduck007" class="contact-item" target="_blank" rel="noopener noreferrer">
                  <span class="contact-icon">
    ...
    var dialog = modal.querySelector(".modal-content");
    ...
    if (window.contactModalKeydownHandler) {
        document.removeEventListener("keydown", window.contactModalKeydownHandler);
    }
    window.contactModalKeydownHandler = handleKeydown;
